...
const editorConfig = {
    ...
    nodes: [ParagraphNode, TextNode, HeadingNode, ListNode, ListItemNode, LinkNode, CodeNode, CodeHighlightNode],
    onError(error: Error) {
        throw error;
    },
    theme: ExampleTheme,
...
export default function RichTextEditor({
    ...
    const placeholderElement = (
        <div className="text-black/40 overflow-hidden text-base select-none inline-block pointer-events-none absolute text-ellipsis top-4 left-2.5">{placeholder}</div>
    );
    ...
    return (
        <LexicalComposer initialConfig={memoizedEditorConfig}>
            <div className={cn(className, "mx-auto max-w-full relative text-left h-auto overflow-auto")}>
                <ToolbarPlugin />
